...
<html lang="en">
<head>
	<title>Login Aviation Security</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				<form action="" method="POST" class="login100-form validate-form">
					<span class="login100-form-logo">
						<img src="images/unnamed.png" witdh="auto" height="160px"> 
					</span>

					<span class="login100-form-title p-b-27 p-t-27">
						Daily Test <br>Aviation Security
					</span>
					...
					<div class="text-center p-t-13">
						<a class="txt1" href="">
							PT. Angkasa Pura 1 <br>Bandar Udara Internasional Jendral Ahmad Yani Semarang
						</a>
					</div>
				</form>
			</div>
