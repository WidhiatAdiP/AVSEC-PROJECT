...
<?php
 ...
 <?php
// $link = mysqli_connect("localhost", "root", "", "dailytest");
...
$id_lap = $_GET['id_lap'];
if ($result = mysqli_query($conn, "SELECT * FROM lap_txr1 WHERE id_lap='$id_lap'")) {
// print_r($id_lap);
...
<br>');
$nama_file='Laporan_';
$mpdf->Output($nama_file.''.$row['id_lap'].'-'.$row['jenis_lap'].'-'.date(("d-m-Y"), strtotime($row['tanggal'])).'.pdf' ,'I');