...
<body>
	...
	if (isset($_POST['edit'])) {
		//edit
		$sql = "UPDATE user SET id_user = '$id_user' , username = '$username' , password = '$password' , nama = '$nama', ttd_img = '$ttd_img', level = '$level' WHERE id_user = '$id_user'";
		if (mysqli_query($conn, $sql)) {
	...
	<form method="post" action="">
		<div class="table-wrapper">
			...
			<table id="tabel-data" class="table table-striped table-hover">
                ...
                <?php
					$i = 0;
					$ksql = "SELECT * FROM user ORDER BY id_user DESC";
								...
								<div class="modal-content">
									<form method="post" action="">
										...
										<div class="modal-body">
											<p>Are you sure you want to delete these Records <?php echo $krow['id_user']; ?>?</p>
